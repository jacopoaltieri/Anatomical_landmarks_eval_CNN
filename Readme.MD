...
## Usage
The script runs in python 3.10.12, please use this version to ensure compatibility, especially if you wish to use the pre-trained model.
#### Requirements
- keras==2.14.0
- matplotlib==3.8.0
- numpy==1.26.1
